"""
pKa test using run_freq_job to get Gibbs free energies.
Pipeline: load HF -> remove proton -> freq(HF) -> freq(F-) -> LLM compute pKa.
"""
import asyncio
import json
import os
...
PLAN = {
    "user_text": "Calculate pKa of HF using freq for Gibbs free energy",
    "name": "pKa of HF (freq test)",
    "version": "1.3",
    ...
    "nodes": [
        ...
        },
        {
            ...
            "output_id": "f_anion",
            "needs": ["remove_proton"],
            "args": {"input_geom_id": "f_anion", "method": "B3LYP", "basis": "def2-SVP"},
            "expect": {"status_in": ["ok"], "artifacts_required": [], "properties_required": []},
        ...
        },
        {
            ...
            "kind": "llm",
            "task": "compute_pka",
            "needs": ["freq_hf", "freq_f_anion"],
            "prompt": (
                "Compute pKa of HF from Gibbs free energies.\n"
